...
class RegistroControl{
    ...
    async guardar_manual(req,res){
        if(req.body.hasOwnProperty('valor_medido') &&
            ...
            try {
                ...
                var fecha_actual = fecha_hora_actual.toISOString().slice(0,10);
                //var hora_actual = fecha_hora_actual.getHours()+":"+fecha_hora_actual.getMinutes()+":"+fecha_hora_actual.getSeconds();
                var hora_actual = fecha_hora_actual.getUTCHours() + ":" + fecha_hora_actual.getUTCMinutes() + ":" + fecha_hora_actual.getUTCSeconds();
                var data={
                    fecha:fecha_actual,
                    hora:hora_actual,
    ...
    //TODO xd Listar últimos registros
}
